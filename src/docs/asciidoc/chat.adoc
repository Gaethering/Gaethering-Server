...
* HTTP Request
include::{snippets}/chat/get-chat-information/failure/member-not-found/http-request.adoc[]

* Path Parameter
include::{snippets}/chat/get-chat-information/failure/member-not-found/path-parameters.adoc[]

* Request Headers
include::{snippets}/chat/get-chat-information/failure/member-not-found/request-headers.adoc[]

* HTTP Response
include::{snippets}/chat/get-chat-information/failure/member-not-found/http-response.adoc[]

* Response Body
include::{snippets}/chat/get-chat-information/failure/member-not-found/response-body.adoc[]
