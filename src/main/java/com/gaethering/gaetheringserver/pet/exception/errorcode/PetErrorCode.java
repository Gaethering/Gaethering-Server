...
public enum PetErrorCode implements ErrorCode {
    ...
    REPRESENTATIVE_PET_NOT_FOUND("E1005", "대표 반려동물이 존재하지 않습니다."),
    EXCEED_REGISTRABLE_PET("E1006", "반려동물은 최대 3마리를 넘을 수 없습니다."),
    FAILED_DELETE_PET("E1007", "반려동물은 1마리 이상이어야 합니다."),
    FAILED_DELETE_REPRESENTATIVE("E1008", "대표 반려동물은 삭제할 수 없습니다.");
